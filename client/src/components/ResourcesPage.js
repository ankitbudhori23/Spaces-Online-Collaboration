...
class ResourcesPage extends React.Component {
  ...
  removeResource = async () => {
    const res = await fetch("http://localhost:5000/removeResource", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  async getData() {
    const getSpaceMilestonesURL =
      "http://localhost:5000/viewSpaceResources/" + `${this.token}`;
    axios
      .get(`${getSpaceMilestonesURL}`)
      .then((res) => {
        var resources = [];
  ...
  async componentWillMount() {
    const getSpaceDataURL = "http://localhost:5000/overview/" + `${this.token}`;
    axios
      .get(`${getSpaceDataURL}`)
      .then((res) => {
            ...
            <div class="main_content">
              ...
              <div class="info">
                            ...
                            <td styles="text-align:center">
                              <button
                                ...
                                onClick={() => {
                                  ...
                                  this.setState({
                                    deleteResourceDisplay: { display: "block" },
                                  });
                ...
                {token.admin ? (
                  <div class="cost-buttons-row">
                    <button
                      ...
                      onClick={() => {
                        this.setState({
                          addResourceDisplay: { display: "block" },
                        });
                        console.log("addup");
                      }}
                    >
                ...
                <div
                  ...
                  id="add-resource-dialog-box"
                  style={this.state.addResourceDisplay}
                >
                ...
                <div
                  class="common-dialog-box-background"
                  id="remove-resource-dialog-box"
                  style={this.state.deleteResourceDisplay}
                >
                  <div class="common-dialog-box">
                    <div class="common-dialog-box-title">
              ...
              <div class="resources-manager-page-blank-bottom-margin"></div>
            </div>
          </div>
        </Fragment>
      );
