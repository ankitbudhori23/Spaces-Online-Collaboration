...
class OverviewPage extends React.Component {
  ...
  async componentWillMount() {
    if (localStorage.getItem("token")) {
      ...
      //GET OVERVIEW DATA:--->
      const getSpaceDataURL = "http://localhost:5000/overview/" + `${token}`;
      axios
        .get(`${getSpaceDataURL}`)
        .then((res) => {
      ...
      //GET TASKS:-->
      const getMyTasksURL =
        "http://localhost:5000/viewSpaceTasks/" + `${token}`;
      axios
        .get(`${getMyTasksURL}`)
        .then((res) => {
      ...
      //GET MILESTONE:-->
      const getSpaceGoalsURL =
        "http://localhost:5000/viewSpaceGoals/" + `${token}`;
      console.log("Getting Data");
      axios
        .get(`${getSpaceGoalsURL}`)
        .then((res) => {
            ...
            <div class="main_content">
              <div class="header">
                ...
                <div class="header-in-detail">
                  <p>
                    Space name: <b>{this.state.space.name}</b>
                  </p>
                  <p>
                    Space id: <b>{this.state.space.uniqueSpaceId}</b>
                  </p>
                </div>
              </div>
              ...
              <div class="info">
                ...
                <div class="goals-cards-row">
                  <div
                    class="goals-card"
                    onClick={() => window.open("/CalendarPage", "_self")}
                  >
                    ...
                    <div class="goals-card-description">
                      <p>
                        This module allows user to view all the tasks and goals
                        assigned to them in a calendar view
                      </p>
                    </div>
                  </div>
                  ...
                  <div
                    class="goals-card"
                    onClick={() => window.open("/TasksPage", "_self")}
                  >
                    <div class="goals-card-title">
                      <h1>Tasks</h1>
                      <Link to="#">
                    ...
                    <div class="goals-card-description">
                      <p>
                        This module allows project leader to assign tasks to
                        members. Members can see tasks assigned to them
                      </p>
                    </div>
                  </div>
                  ...
                  <div
                    class="goals-card"
                    onClick={() => window.open("/TeamManagement", "_self")}
                  >
                    <div class="goals-card-title">
                      <h1>Members</h1>
                      <Link to="#">
                    ...
                    <div class="goals-card-description">
                      <p>
                        The module shows the list of all team members with their
                        skill set in the form of a card view.
                      </p>
                    </div>
                  </div>
                  ...
                  <div
                    class="goals-card"
                    onClick={() => window.open("/GoalsPage", "_self")}
                  >
                    <div class="goals-card-title">
                      <h1>Goals</h1>
                      <Link to="#">
                    ...
                    <div class="goals-card-description">
                      <p>
                        The module shows all the major goals of project and
                  ...
                  <div
                    class="goals-card"
                    onClick={() => window.open("/ConferencingPage", "_self")}
                  >
                    <div class="goals-card-title">
                      <h1>Conferencing</h1>
                      <Link to="#">
                    ...
                    <div class="goals-card-description">
                      <p>
                        The module allows communication between members. Members
                  ...
                  <div
                    class="goals-card"
                    onClick={() => window.open("/FlowChartPage", "_self")}
                  >
                    <div class="goals-card-title">
                      <h1>Flow Chart</h1>
                      <Link to="#">
                    ...
                    <div class="goals-card-description">
                      <p>
                        The module allows users to create flow charts and these
                        flowcharts can be saved to the database.{" "}
                      </p>
                    </div>
                  </div>
                  ...
                  <div
                    class="goals-card"
                    onClick={() => window.open("/EditorPage", "_self")}
                  >
                    <div class="goals-card-title">
                      <h1>Editor</h1>
                      <Link to="#">
                    ...
                    <div class="goals-card-description">
                      <p>
                        The module will give a realtime collaborative
                        environment to users to code or write some text.{" "}
                      </p>
                    </div>
                  </div>
                </div>
