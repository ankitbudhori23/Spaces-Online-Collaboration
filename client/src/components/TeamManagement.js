...
class TeamManagement extends React.Component {
  ...
  PostData = async () => {
    ...
    const res = await fetch("http://localhost:5000/addMember", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
      body: JSON.stringify({
        memberEmailID: this.emailID,
        token: this.token,
      }),
    });
  ...
  PostRemovalData = async () => {
    //(e)
    // e.preventDefault();
    //const { email ,phone, skills, password, cpassword } = user;//Obj destructuring
    const res = await fetch("http://localhost:5000/removeMember", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  async getData() {
    ...
    const getMembersDataURL =
      "http://localhost:5000/viewMembers/" + `${this.token}`;
    axios
    ...
    //GETING MANAGER DATA:--->
    const getAdminDataURL =
      "http://localhost:5000/viewAdmin/" + `${this.token}`;
    axios
      .get(`${getAdminDataURL}`)
      .then((res) => {
      ...
      if (token.admin) {
        buttons = (
          <div class="member-buttons-row">
            <button class="add-member-button" onClick={this.onAddMemberClick}>
              {" "}
              Add New Member{" "}
            </button>
            ...
            <button
              ...
              onClick={this.onRemoveMemberClick}
            >
              Remove a member
            </button>
          </div>
            ...
            <div class="team-member-card-row4">
              ...
              <p>UI/UX, HTML, CSS, FLUTTER</p>
                  ...
                  <div
                    ...
                    id="add-member-dialog-box"
                    style={this.state.displayAddMmebers}
                  >
                    <div class="common-dialog-box">
                      ...
                      <div class="common-dialog-box-buttons-row">
                        ...
                        <button
                          ...
                          onClick={this.onAddMemberCancel}
                        >
                          Cancel
                        </button>
                  ...
                  <div
                    class="common-dialog-box-background"
                    id="remove-member-dialog-box"
                    style={this.state.displayRemoveMmebers}
                  >
                    <div class="common-dialog-box">
                      <div class="common-dialog-box-title">
                      ...
                      <div class="common-dialog-box-buttons-row">
                        ...
                        <button
                          class="common-dialog-box-cancel-button"
                          onClick={this.onRemoveMemberCancel}
                        >
                          Cancel
                        </button>
                      </div>
