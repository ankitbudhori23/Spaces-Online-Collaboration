...
class FlowChartPage extends React.Component {
  ...
  AddNewFlowchart = async () => {
    const res = await fetch("http://localhost:5000/addFlowchart", {
      method: "POST",
      headers: {
  ...
  UpdateFlowchart = async () => {
    const res = await fetch("http://localhost:5000/updateFlowchart", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  DeleteFlowchart = async () => {
    const res = await fetch("http://localhost:5000/removeFlowchart", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  async getData() {
    ...
    const getSpaceFlowchartsURL =
      "http://localhost:5000/viewSpaceFlowcharts/" + `${token}`;
    console.log("Getting Data");
    axios
      .get(`${getSpaceFlowchartsURL}`)
      .then((res) => {
        ...
        <Fragment>
          ...
          <div class="wrapper">
            ...
            <div class="previous-flowchart-container">
              ...
              <br></br>
              {this.state.flowcharts
                ? this.state.flowcharts.map((flowchart) => (
                    <div
                      class={
                        this.state.flowchartID === flowchart._id
                  ...
                  <div class="flowchart">
                        ...
                        <div class="flowchart-code-area">
                          ...
                          <div class="flowchart-image-area">
                            ...
                            {this.code.current == null ? (
                              <section>
                                <h1>
                                  Type code in editor to render flowchart.
                                </h1>
                                <h1>Example:- </h1>
                    ...
                    <div class="common-dialog-box-buttons-row">
                      ...
                      <button
                        ...
                        onClick={this.handleSaveFlowchart}
                      >
                      ...
                      {this.state.flowchartID.trim() != "" ? (
                        <div class="common-dialog-box-buttons-row">
                          <button
                            class="common-dialog-box-confirm-button"
                            onClick={this.handleUpdateFlowchart}
                          >
                            Update Flowchart
                          </button>
                        </div>
