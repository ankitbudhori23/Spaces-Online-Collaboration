...
class CostsPage extends React.Component {
  ...
  AddNewExpense = async () => {
    const res = await fetch("http://localhost:5000/addCost", {
      method: "POST",
      headers: {
  ...
  async getData() {
    ...
    const getCostDataURL =
      "http://localhost:5000/viewSpaceCosts" + "/" + `${this.token}`;
    const getProjectDataURL =
      "http://localhost:5000/overview/" + `${this.token}`;
    axios
      .get(`${getCostDataURL}`)
      .then((res) => {
  ...
  removeExpense = async () => {
    const res = await fetch("http://localhost:5000/removeCost", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
            ...
            <div class="main_content">
              ...
              <div class="info">
                ...
                <div class="cost-cards-row">
                  ...
                  <div class="budget-remaining-card">
                    ...
                    <div class="budget-remaining-card-row2">
                      <h3>
                        RS. {this.state.projectBudget - this.state.totalSpent}
                      </h3>
                    </div>
                  </div>
                </div>
                          ...
                          <td styles="text-align:center">
                            <button
                              ...
                              onClick={() => {
                                this.name = Cost.name;
                                this.setState({
                                  displayDeleteExpense: { display: "block" },
                                });
                ...
                <div
                  ...
                  id="add-expense-dialog-box"
                  style={this.state.displayAddExpense}
                >
                ...
                <div
                  class="common-dialog-box-background"
                  id="remove-expense-dialog-box"
                  style={this.state.displayDeleteExpense}
                >
                  <div class="common-dialog-box">
                    <div class="common-dialog-box-title">
                      <h1>{this.name}</h1>
