...
class MainPage extends React.Component {
  ...
  async getData() {
    if (localStorage.getItem("token")) {
      ...
      const getSpaceDataURL = "http://localhost:5000/profileInfo/" + `${token}`;
      axios
        .get(`${getSpaceDataURL}`)
        .then((res) => {
        ...
        <Fragment>
          ...
          <div class="edit-profile-whole-page">
            <div class="edit-profile-container">
              ...
              <form action="#">
                <div
                  class="edit-profile-user-details"
            ...
            <div
              ...
              id="confirm-edit-profile-dialog-box"
              style={this.state.confirmDisplay}
            >
