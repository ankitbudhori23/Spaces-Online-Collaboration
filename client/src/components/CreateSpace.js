...
const CreateSpace = () => {
  ...
  const PostData = async (e) => {
    ...
    const {
      ...
      spaceDescription,
      budget,
    } = space; //Obj destructuring
    const res = await fetch("http://localhost:5000/createNewSpace", {
      method: "POST",
      headers: {
      ...
      body: JSON.stringify({
        name,
        adminEmailId,
        spaceUsersEmailId: spaceUsersEmailId.split(";"),
        emailDomain,
        uniqueSpaceId,
        spaceDescription,
        budget,
  ...
  function validateForm(e) {
    ...
    if (f === null || f === "") {
      ...
      error++;
      document.getElementById("spaceUsersEmailId_error").innerHTML =
        "Please fill the members EmailID";
    } else {
    ...
    if (g === null || g === "") {
      ...
      error++;
      document.getElementById("spaceDescription_error").innerHTML =
        "Please fill a space Description.";
    }
    ...
    if (h === null || h === "") {
      ...
      error++;
      document.getElementById("budget_error").innerHTML =
        "Project Budget must be filled out";
    }
      ...
      <div class="create-new-space-container">
        ...
        <form action="#" name="createNew_space">
          <div class="create-new-space-user-details">
            ...
            <div class="create-new-space-row-2"></div>
            ...
            <div class="create-new-space-row-4">
              <div class="create-new-space-input-box">
                <span>
                  <b>Add members email address</b>(separated by ';')
                </span>
                <input
                  type="text"
                  name="spaceUsersEmailId"
                  id="spaceUsersEmailId"
