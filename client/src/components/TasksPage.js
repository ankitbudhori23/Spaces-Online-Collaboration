...
class TasksPage extends React.Component {
  ...
  async getData() {
    if (localStorage.getItem("token")) {
      ...
      axios
        .get("http://localhost:5000/viewSpaceTasks/" + `${token}`)
        .then((res) => {
        ...
        if (token.admin) {
          ...
          addTaskButton = (
            <div class="tasks-button-row">
              <button class="purple-button" onClick={this.addTaskButtonClick}>
                Add New Task
              </button>
            </div>
          );
          ...
          <div class="wrapper">
            ...
            <div class="main_content">
              <div class="header">
                ...
                <br />
                <p>
                  Space name: <b>{localStorage.getItem("spaceName")}</b>
                </p>
              </div>
              ...
              <div class="info">
                ...
                <div class="tab">
                  <button
                    class={this.state.Inprogress_TabLink}
                    onClick={() => {
                      this.setState({
                        Inprogress_display: { display: "flex" },
                      });
                  ...
                  <button
                    class={this.state.Upcoming_TabLink}
                    onClick={() => {
                      this.setState({
                        Inprogress_display: { display: "none" },
                      });
                  ...
                  <button
                    class={this.state.Completed_TabLink}
                    onClick={() => {
                      this.setState({
                        Inprogress_display: { display: "none" },
                      });
                ...
                <div
                  class="task-outer-box-row"
                  id="in_progress"
                  style={this.state.Inprogress_display}
                >
                  <div class="tasks-outer-box">
                    <div class="tasks-row">
                      {this.state.inProgressTasks.map(
                        (inProgressTask, index) => (
                          <div class="task-card">
                            <div class="task-card-row1">
                              <p>{inProgressTask.name}</p>
                              <button type="task_edit_button">
                                <i
                                  class="fas fa-pencil-alt"
                                  onClick={() => {
                                    this.setState({
                                      displayEditTask: { display: "block" },
                                    });
                                    ...
                                    this.Editname.current.value =
                                      inProgressTask.name;
                                    this.Editemails.current.value =
                                      inProgressTask.assignedTo.join(";");
                                    this.Edittime.current.value =
                                      inProgressTask.time;
                                    this.Editstatus.current.value =
                                      inProgressTask.status;
                                    this.EditstartDate.current.value = new Date(
                                      inProgressTask.startDate
                                    )
                                      .toISOString()
                                      .split("T")[0];
                                    this.EditendDate.current.value = new Date(
                                      inProgressTask.endDate
                                    )
                                      .toISOString()
                                      .split("T")[0];
                                  }}
                            ...
                            <div class="task-card-row1point5">
                              <p>
                                Time:- <span>{inProgressTask.time} Hrs</span>
                              </p>
                            </div>
                            <div class="task-card-row2">
                              ...
                              <p>
                                Assigned to:-
                                {inProgressTask.assignedTo.map((item) => (
                                  <p key={item}>
                                    <span>{item}</span>
                                  </p>
                                ))}
                ...
                <div
                  class="task-outer-box-row"
                  id="up_coming"
                  style={this.state.Upcoming_display}
                >
                  <div class="tasks-outer-box">
                    <div class="tasks-row">
                      {this.state.upcomingTasks.map((upcomingTask, index) => (
                        <div class="task-card">
                              ...
                              <i
                                ...
                                onClick={() => {
                                  ...
                                  this.Editname.current.value =
                                    upcomingTask.name;
                                  this.Editemails.current.value =
                                    upcomingTask.assignedTo.join(";");
                                  this.Edittime.current.value =
                                    upcomingTask.time;
                                  this.Editstatus.current.value =
                                    upcomingTask.status;
                                  this.EditstartDate.current.value = new Date(
                                    upcomingTask.startDate
                                  )
                                    .toISOString()
                                    .split("T")[0];
                                  this.EditendDate.current.value = new Date(
                                    upcomingTask.endDate
                                  )
                                    .toISOString()
                                    .split("T")[0];
                                }}
                          ...
                          <div class="task-card-row1point5">
                            <p>
                              Time:- <span>{upcomingTask.time} Hrs</span>
                            </p>
                          </div>
                          <div class="task-card-row2">
                            <br></br>
                            <p>
                              Assigned to:-
                              {upcomingTask.assignedTo.map((item) => (
                                <p key={item}>
                                  <span>{item}</span>
                                </p>
                              ))}
                ...
                <div
                  class="task-outer-box-row"
                  id="completed"
                  style={this.state.Completed_display}
                >
                  <div class="tasks-outer-box">
                    <div class="tasks-row">
                      {this.state.completedTasks.map((completedTask, index) => (
                        <div class="task-card">
                          ...
                          <div class="task-card-row1point5">
                            <p>
                              Time:- <span>{completedTask.time} Hrs</span>
                            </p>
                          </div>
                          ...
                          <div class="task-card-row2">
                            ...
                            <p>
                              Assigned to:-
                              {completedTask.assignedTo.map((item) => (
                                <p key={item}>
                                  <span>{item}</span>
                                </p>
                              ))}
                ...
                <div class="time-spent-outer-box-row">
                  <div class="time-spent-outer-box">
                    <h1>
                      {this.time_convert(this.state.totalTimeSpent) + " "}hrs
                    </h1>
                  </div>
                </div>

                <div
                  class="common-dialog-box-background"
                  id="add-task-dialog-box"
                  style={this.state.displayAddTask}
                >
                  <div class="common-dialog-box">
                    ...
                    <div class="common-dialog-box-buttons-row">
                      ...
                      <button
                        ...
                        onClick={this.cancelAddTaskPopUpClick}
                      >
                        Cancel
                      </button>
                    </div>
                ...
                <div
                  class="common-dialog-box-background"
                  id="edit-task-dialog-box"
                  style={this.state.displayEditTask}
                >
                  <div class="common-dialog-box">
                    <div class="common-dialog-box-title">
                      <h1>Edit task</h1>
                    ...
                    <form action="#">
                      <div class="common-dialog-box-details">
                        ...
                        <div
                          class="common-dialog-box-input-box"
                          style={this.assigned}
                        >
                          <span>
                            Assigned to <br />
                    ...
                    <div class="common-dialog-box-buttons-row">
                      ...
                      <button
                        class="common-dialog-box-cancel-button"
                        onClick={this.editTaskButtonCancel}
                      >
                        Cancel
                      </button>
                    </div>
