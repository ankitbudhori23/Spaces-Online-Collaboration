    ...
    <div class="video-box">
      <StyledVideo
        ...
        poster={
          ...
          props.name +
          "&size=72&rounded=true"
        }
      ></StyledVideo>
      <Avatar
        id={"avatar" + props.Key1}
        src={"http://ui-avatars.com/api/?name=" + props.name}
        size="lg"
        style={{ display: "none" }}
      />
    ...
    navigator.mediaDevices
      ...
      .then((stream) => {
        ...
        socketRef.current.on("user Left", (payload) => {
          //const peer = addPeer(payload.signal, payload.callerID, stream);
          const ptoremove = peersRef.current.filter(
          ...
          var newpeers = [];
          peersRef.current.map((npeer) => {
            newpeers.push(npeer.peer);
          });
          setPeers(newpeers);
        ...
        <div class="main_content">
          <Container>
            <div class="video-box">
              ...
              />
              <Avatar
                src={"http://ui-avatars.com/api/?name=" + paramsName}
                size="lg"
                style={{ display: videoEnabled ? "none" : "block" }}
              />
              <p> You </p>
            </div>
          ...
          <div class="video-call-button-row">
            ...
            <button id="end_call_button">
              <Link to="http://localhost:3000/ConferencingPage" target="_self">
                <p>
            ...
            >
              <p>
                <i
                  class={videoEnabled ? "fas fa-video" : "fas fa-video-slash"}
                ></i>
              </p>
            </button>
          </div>
