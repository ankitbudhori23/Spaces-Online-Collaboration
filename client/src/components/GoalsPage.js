...
class GoalsPage extends React.Component {
  ...
  async componentDidMount() {
    ...
    const getSpaceDataURL =
      "http://localhost:5000/overview/" + `${localStorage.getItem("token")}`;
    this.getData();
    axios
      .get(`${getSpaceDataURL}`)
      .then((res) => {
            ...
            <div class="wrapper">
              ...
              <div class="main_content">
                ...
                <div class="info">
                  <br />
                  <div
                    class="goals-and-deliverables"
                    id="goals-box"
                    style={this.state.GoalsDisplay}
                  >
                          ...
                          {this.state.currentGoals.map((Goal, index) => (
                            <tr>
                              ...
                              <td styles="text-align:center">
                                <button
                                  class="mark_as_complete_button"
                                  onClick={() => {
                                    this.name = Goal.name;
                                    this.setState({
                                      confirmGoalDisplay: { display: "block" },
                                    });
                              ...
                              <td styles="text-align:center">
                                <button
                                  class="delete_table_row_button"
                                  onClick={() => {
                                    this.name = Goal.name;
                                    this.setState({
                                      deleteGoalDisplay: { display: "block" },
                                    });
                    ...
                    <div
                      ...
                      id="task-completed-confirmation-dialog-box"
                      style={this.state.confirmGoalDisplay}
                    >
                    ...
                    <div
                      class="common-dialog-box-background"
                      id="task-completed-confirmation-dialog-box"
                      style={this.state.confirmDeliverableDisplay}
                    >
                      <div class="common-dialog-box">
                        <div class="common-dialog-box-title">
                          <h1>Confirmation</h1>
                        ...
                        <p>
                          Are you sure you want to mark this Deliverable as
                          completed?
                        </p>
                        <br />
                        <br />
                        ...
                        <div class="common-dialog-box-buttons-row">
                          ...
                          <button
                            ...
                            onClick={() => {
                              this.setState({
                                confirmDeliverableDisplay: { display: "none" },
                              });
                            }}
                          >
                            No
                    ...
                    <div
                      class="common-dialog-box-background"
                      id="add-goal-dialog-box"
                      style={this.state.addGoalDisplay}
                    >
                      <div class="common-dialog-box">
                        <div class="common-dialog-box-title">
                          ...
                          <div class="common-dialog-box-details">
                            ...
                            <div class="common-dialog-box-input-box">
                              ...
                              <input
                                ...
                                ref={this.GoalExpectedCompletionDate}
                              />
                            </div>
                    ...
                    <div
                      class="common-dialog-box-background"
                      id="add-goal-dialog-box"
                      style={this.state.addDeliverableDisplay}
                    >
                      <div class="common-dialog-box">
                        <div class="common-dialog-box-title">
                          ...
                          <div class="common-dialog-box-details">
                            ...
                            <div class="common-dialog-box-input-box">
                              ...
                              <input
                                type="date"
                                placeholder="yyyy-mm-dd"
                                ref={this.DeliverableExpectedCompletionDate}
                              />
                            </div>
                            ...
                            <div class="common-dialog-box-input-box">
                              ...
                              <input
                                type="text"
                                ref={this.DeliverableDescription}
                              />
                            </div>
                          </div>
                        </form>
                        ...
                        <div class="common-dialog-box-buttons-row">
                          <button
                            class="common-dialog-box-confirm-button"
                            onClick={this.handleNewDeliverable}
                          >
                            Add Deliverable
                          </button>
                          ...
                          <button
                            ...
                            onClick={() => {
                              this.setState({
                                addDeliverableDisplay: { display: "none" },
                              });
                            }}
                          >
                            Cancel
                  ...
                  <div
                    class="common-dialog-box-background"
                    id="delete-goal-dialog-box"
                    style={this.state.deleteGoalDisplay}
                  >
                    <div class="common-dialog-box">
                      <div class="common-dialog-box-title">
                        <h1>Delete goal</h1>
